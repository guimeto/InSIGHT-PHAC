...
while iw2  <  df_epi.shape[0] : 
    ...
    for year in range(1985,2015):
        ...
        ds_week3 = ds.sel(longitude=slice(*lon_bnd), latitude=slice(*lat_bnd),time=slice(datei3, datef3)).mean('time')-273.15     
        
        ds_new = (ds_week1 + ds_week2 + ds_week3)/3     
...
ax.set_title('Anomalies absolues des températures moyennes sur 3 semaines epiweeks: '+str(year_to_study)+' par rapport à la normale 1985-2014', weight='bold', fontsize="x-large")
figure = ax.get_figure()    
figure.set_size_inches(22, 15) 
plt.savefig("Anomalies_tri-week_Temperature_"+str(year_to_study)+"_vs_1985-2014_new.png", bbox_inches="tight")
plt.close()
...
ax.set_title('Climatologie des températures moyennes sur 3 epiweek (1985-2014)', weight='bold', fontsize="x-large")
figure = ax.get_figure()    
figure.set_size_inches(22, 15) 
plt.savefig("Climatologies_triweek_Temperatures_1985-2014_new.png", bbox_inches="tight")

dataframe_anomalies.to_csv("Anomalies_triweek_Temperature_"+str(year_to_study)+"_vs_1985-2014_new.csv",  header = True, sep = ',')
dataframe_climatologies.to_csv("Climatologies_Temperatures_triweek_1985-2014_new.csv", header = True, sep = ',')
